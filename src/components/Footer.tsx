...
export function Footer() {
  return (
    <div className="w-full flex flex-col items-center justify-center gap-2 md:grid md:grid-cols-3 md:content-center md:justify-items-center border-t border-indigo-800 p-3">
      <span className="text-indigo-400 font-extralight text-sm">
        Copyright © Renato Willon · {Ano}
      </span>

      <div className="flex gap-3">
        <a href="https://www.linkedin.com/in/renatowillon/" target="_blank">
          <FaLinkedin fill="#818cf8" size={25} />
        </a>
        <a href="https://github.com/renatowillon/" target="_blank">
          <FaGithub fill="#818cf8" size={25} />
        </a>
        <a href="https://www.instagram.com/renato.willon/" target="_blank">
          <FaInstagram fill="#818cf8" size={25} />
        </a>
      </div>
