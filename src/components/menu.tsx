...
export function Menu(){
    return(
      ...
      <div className="text-indigo-300 flex items-center text-sm font-normal gap-5">
          ...
          <a href="#" className="hover:text-indigo-500 hover:font-semibold transition-colors duration-500">Skills</a>
          <a href="#" className="hover:text-indigo-500 hover:font-semibold transition-colors duration-500">Carreira</a>
          <a href="#" className="hover:text-indigo-500 hover:font-semibold transition-colors duration-500">Contato</a>
